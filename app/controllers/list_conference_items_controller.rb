...
class ListConferenceItemsController < ApplicationController
  ...
  ListConferenceItemsController.solr_search_params_logic = CatalogController.solr_search_params_logic - [:add_advanced_parse_q_to_solr, :add_advanced_search_to_solr]
  # Add query filter
