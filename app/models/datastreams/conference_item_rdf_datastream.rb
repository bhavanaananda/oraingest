...
class ConferenceItemRdfDatastream < ActiveFedora::NtriplesRDFDatastream
  ...
  attr_accessor :title, :subtitle, :abstract, :subject, :keyword, :worktype, :medium, :language, :publicationStatus, :reviewStatus, :license, :dateCopyrighted, :rightsHolder, :rightsHolderGroup, :rights, :rightsActivity, :creation, :funding, :publication, :presentedAt, :conferenceActivity
